...
public partial class DynamicQuery : System.Web.UI.Page
{
    string viewName;
    ...
    public static DynamicQuery _QueryBuilder;

    
            
        protected void Page_Load(object sender, EventArgs e)
        {
            _QueryBuilder = new DynamicQuery();
            _QueryBuilder = this;
            SetNewInstance();
            if (!IsPostBack)
            {
        ...
        public DynamicQuery(string vName)
        {
            viewName = vName;
        }
    ...
    protected void LoadTable()
    {
        ...
        string ConString = ConfigurationManager.ConnectionStrings["CommandoDatabaseConnectionString"].ConnectionString;
    ...
    {
        if (conditionalOpCB.SelectedItem.ToString() == "BETWEEN" || conditionalOpCB.SelectedItem.ToString() == "IN")
        {
