<%@ Page Title="Advance Search Result" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="AdvanceSearchResultList.aspx.cs" Inherits="Pages_Search_AdvanceSearchResultList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="category-content">
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="gv" runat="server" ShowHeader="True" AutoGenerateColumns="False" PageSize="23"
                            DataKeyNames="ArmyNo" AllowPaging="true" OnPageIndexChanging="gv_PageIndexChanging"
            ...
            <asp:Panel runat="server" ID="plcPaging" CssClass="paginationArea" Visible="false" />
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
