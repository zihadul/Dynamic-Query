...
public partial class Pages_Search_AdvanceSearchResultList : BasePage
{
    #region variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Session["AdvanceSearchCriteria"] != null)
            {
                SearchText = Session["AdvanceSearchCriteria"].ToString();
                LoadData();
            }
            //BindData();
        }
    ...
    private void BindData()
    {
        ...
        DataTable dtt = (DataTable)Session["AdvanceSearch"];

        //dt = new bllBasicInfo().GetBySearchParameter(CurrentPage * PageSize, PageSize, Criteria, PrintMode);
