<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="AddEditMSN.aspx.cs" Inherits="Pages_Setup_AddEditMSN" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-8 col-sm-9 col-md-10">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="Submit"
                                        runat="server" ErrorMessage="Enter MNS Group Name." ControlToValidate="tbxName"></asp:RequiredFieldValidator>
                                </div>
                                <div class="col-xs-4 col-sm-3 col-md-2">
                                    MSN Group:
                                </div>
                                <div class="col-xs-8 col-sm-9 col-md-10">
                                    <asp:DropDownList CssClass="form-control" runat="server" ID="ddlMSNGroup" SkinID="LongDDL"
                                        DataValueField="MNSGroupId" DataTextField="MNSGroupName" AutoPostBack="True"
                                ...
                                <div class="col-xs-8 col-sm-9 col-md-10">
                                    <asp:DropDownList CssClass="form-control" runat="server" ID="ddlCountry" SkinID="LongDDL"
                                        DataValueField="CountryID" DataTextField="CountryName" AutoPostBack="True" AppendDataBoundItems="True" />
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12" style="margin-bottom: 20px;">
                                </div>
                                <div class="col-xs-4 col-sm-3 col-md-2">
                                ...
                                <div class="col-xs-8 col-sm-9 col-md-10">
                                    <asp:TextBox ID="tbxDescription" runat="server" SkinID="LongText" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="col-xs-4 col-sm-2 col-md-2 bakBtn">
                                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-success" Text="Back" CausesValidation="false"
                                        PostBackUrl="~/Pages/Setup/MSNList.aspx" />
                                </div>
                            </div>
                        </div>
                    </asp:Panel>
