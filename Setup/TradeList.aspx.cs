...
public partial class Pages_Setup_TradeList : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        {
            Criteria = Session["TradeCriteria"].ToString();

        }
        else
        {
            Criteria = GetCriteria();
            Session["TradeCriteria"] = Criteria;
        }

        dt = new bllTrade().GetBySearchParameter(CurrentPage * PageSize, PageSize, Criteria, PrintMode);
        gv.DataSource = dt;
        gv.DataBind();
        if (dt.Rows.Count > 0)
        {
    ...
    private string GetCriteria()
    {
        ...
        if (tbxTradeName.Text.Trim() != "")
        {
            if (Criteria == "") Criteria = "TradeName like '%" + tbxTradeName.Text.Trim() + "%'";
            else Criteria += " And TradeName like '%" + tbxTradeName.Text.Trim() + "%'";
        }
