<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="AddEditMedicalCategory.aspx.cs" Inherits="Pages_Admin_AddEditMedicalCategory" %>
                    ...
                    <div class="comn-mgn-btm">
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-sm-3 col-md-2">
                                Medical Category Name:<font color="red">*</font>
                            </div>
                            <div class="col-xs-8 col-sm-9 col-md-10">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="Submit"
                                    runat="server" ErrorMessage="Enter Medical Category Name." ControlToValidate="tbxName"></asp:RequiredFieldValidator>
                            </div>
                            <div class="col-xs-4 col-sm-3 col-md-2">
                            ...
                            <div class="col-xs-4 col-sm-2 col-md-2 bakBtn">
                                <asp:Button ID="Button1" runat="server" CssClass="btn btn-success" Text="Back" CausesValidation="false"
                                    PostBackUrl="~/Pages/Setup/MedicalCategoryList.aspx" />
                            </div>
                        </div>
                    </div>
                </asp:Panel>
