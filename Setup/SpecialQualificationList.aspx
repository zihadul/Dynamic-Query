<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="SpecialQualificationList.aspx.cs" Inherits="Pages_Setup_SpecialQualificationList" %>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-8 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-3 col-xs-4">
                                <asp:TextBox CssClass="form-control" ID="tbxSpclQulty" runat="server"></asp:TextBox>
                            </div>
            ...
            <ContentTemplate>
                <div class="row">
                    <div class="col-xs-6 col-sm-2 col-md-2 mrgn-btm10px">
                        <asp:Button ID="btnRank" runat="server" Text="Add New" PostBackUrl="~/Pages/Setup/AddEditSpecialQualification.aspx"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" SkinID="SampleGridView"
                            ...
                            PageSize="20" DataKeyNames="SpecialQualityId" Width="100%">
                            <Columns>
                                <asp:BoundField DataField="SpecialQualityName" HeaderText="Special Quality Name"
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <asp:LinkButton SkinID="lnkBtnEdit" ID="btnEdit" runat="server" PostBackUrl='<%# String.Concat("~/Pages/Setup/AddEditSpecialQualification.aspx?ID=", Eval("SpecialQualityId")) %>' />
                                        <asp:LinkButton SkinID="lnkBtnDelete" ID="LinkButton1" runat="server" OnCommand="btnDelete_Command"
                                            ...
                                            CommandArgument='<%# Eval("SpecialQualityId") %>' />
                                    </ItemTemplate>
