<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="CadreList.aspx.cs" Inherits="Pages_Setup_CadreSetup" %>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-8 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-3 col-xs-4">
                            <asp:TextBox CssClass="form-control" ID="tbxCadre" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-4">
                            <div class="">
                                <asp:ImageButton runat="server" ID="btnSearch" SkinID="SearchButton" ImageAlign="left" class="btnSearch-img2"
            ...
            <ContentTemplate>
                <div class="row">
                    <div class="col-xs-6 col-sm-2 col-md-2 mrgn-btm10px">
                        <asp:Button ID="btnRank" runat="server" Text="Add New" PostBackUrl="~/Pages/Setup/AddEditCadre.aspx"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" SkinID="SampleGridView"
                            ...
                            PageSize="20" DataKeyNames="CadreId" Width="100%">
                            <Columns>
                                <asp:BoundField DataField="Cadre" HeaderText="Cadre" HeaderStyle-HorizontalAlign="Center">
                                </asp:BoundField>
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <asp:LinkButton SkinID="lnkBtnEdit" ID="btnEdit" runat="server" PostBackUrl='<%# String.Concat("~/Pages/Setup/AddEditCadre.aspx?ID=", Eval("CadreId")) %>' />
