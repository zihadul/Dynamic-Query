<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="AddEditAprGade.aspx.cs" Inherits="Pages_Setup_AddEditAprGade" %>
                ...
                <asp:Panel ID="defaultEntry" runat="server" DefaultButton="btnSave">
                    <div class="comn-mgn-btm">
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-sm-2 col-md-1">
                                Grade Title:<font color="red">*</font>
                            </div>
                            <div class="col-xs-8 col-sm-10 col-md-11">
                            ...
                            <div class="col-xs-4 col-sm-2 col-md-2 bakBtn">
                                <asp:Button ID="Button1" runat="server" CssClass="btn btn-success" Text="Back" CausesValidation="false"
                                    PostBackUrl="~/Pages/Setup/AprGradeSetupList.aspx" />
                            </div>
                        </div>
                    </div>
                </asp:Panel>
