<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="OffenceList.aspx.cs" Inherits="Pages_Setup_OffenceList" %>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-8 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-3 col-xs-4">
                                <asp:TextBox CssClass="form-control" ID="tbxOffence" runat="server"></asp:TextBox>
                            </div>
            ...
            <ContentTemplate>
                <div class="row">
                    <div class="col-xs-6 col-sm-2 col-md-2 mrgn-btm10px">
                        <asp:Button ID="btnRank" runat="server" Text="Add New" PostBackUrl="~/Pages/Setup/AddEditOffence.aspx"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" SkinID="SampleGridView"
                            ...
                            PageSize="20" DataKeyNames="OffenceId" Width="100%">
                            <Columns>
                                <asp:BoundField DataField="OffenceName" HeaderText="Offence Name" HeaderStyle-HorizontalAlign="Center">
                                </asp:BoundField>
                                <asp:BoundField DataField="Description" HeaderText="Description" HeaderStyle-HorizontalAlign="Center">
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <asp:LinkButton SkinID="lnkBtnEdit" ID="btnEdit" runat="server" PostBackUrl='<%# String.Concat("~/Pages/Setup/AddEditOffence.aspx?ID=", Eval("OffenceId")) %>' />
                                        <asp:LinkButton SkinID="lnkBtnDelete" ID="LinkButton1" runat="server" OnCommand="btnDelete_Command"
                                            ...
                                            CommandArgument='<%# Eval("OffenceId") %>' />
                                    </ItemTemplate>
