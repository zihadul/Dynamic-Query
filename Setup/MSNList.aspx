<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="MSNList.aspx.cs" Inherits="Pages_Setup_MSNList" %>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-8 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-3 col-xs-4">
                            <asp:TextBox CssClass="form-control" ID="tbxMSN" runat="server"></asp:TextBox>
                        </div>
            ...
            <ContentTemplate>
                <div class="row">
                    <div class="col-xs-6 col-sm-2 col-md-2 mrgn-btm10px">
                        <asp:Button ID="btnRank" runat="server" Text="Add New" PostBackUrl="~/Pages/Setup/AddEditMSN.aspx"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" SkinID="SampleGridView"
                            ...
                            PageSize="20" DataKeyNames="MsnId" Width="100%">
                            <Columns>
                                <asp:BoundField DataField="MsnName" HeaderText="MSN Name" HeaderStyle-HorizontalAlign="Center">
                                </asp:BoundField>
                                <asp:BoundField DataField="MNSGroupName" HeaderText="MSN Group Name" HeaderStyle-HorizontalAlign="Center">
                                </asp:BoundField>
                                <asp:BoundField DataField="CountryName" HeaderText="Country Name" HeaderStyle-HorizontalAlign="Center">
                                </asp:BoundField>
                                <asp:BoundField DataField="Description" HeaderText="Description" HeaderStyle-HorizontalAlign="Center">
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <asp:LinkButton SkinID="lnkBtnEdit" ID="btnEdit" runat="server" PostBackUrl='<%# String.Concat("~/Pages/Setup/AddEditMSN.aspx?ID=", Eval("MsnId")) %>' />
