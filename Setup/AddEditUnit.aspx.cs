...
public partial class Pages_Setup_AddEditUnit : System.Web.UI.Page
{
    int ID
    {
    ...
    {
        DataTable dt = new bllUnit().GetById(ID);
    ...
    {
        bdoUnit objUnit = new bdoUnit();
        objUnit.UnitId = ID;
        objUnit.UnitName = tbxName.Text;
        objUnit.Description = tbxDescription.Text;
        new bllUnit().InsertUpdate(objUnit);
