...
public partial class Pages_Setup_ArmsList : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        else
        {
         ...
         dt = new bllArms().GetBySearchParameter(CurrentPage * PageSize, PageSize, Criteria, PrintMode);
        gv.DataSource = dt;
        gv.DataBind();
        if (dt.Rows.Count > 0)
        {
    ...
    private string GetCriteria()
    {
        ...
        if (tbxArms.Text.Trim() != "")
        {
            if (Criteria == "") Criteria = "ArmsName like '%" + tbxArms.Text.Trim() + "%'";
            else Criteria += " And ArmsName like '%" + tbxArms.Text.Trim() + "%'";
        }
