<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="AddEditCadre.aspx.cs" Inherits="Pages_Setup_AddEditCadre" %>
                    ...
                    <div class="comn-mgn-btm">
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-sm-2 col-md-1">
                                Cadre:<font color="red">*</font>
                            </div>
                            <div class="col-xs-8 col-sm-10 col-md-11">
                                <asp:TextBox ID="tbxCadre" runat="server" SkinID="LongText" CssClass="form-control"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="Submit"
                                    runat="server" ErrorMessage="Enter Cadre" ControlToValidate="tbxCadre"></asp:RequiredFieldValidator>
                            </div>
                            <div class="col-xs-4 col-sm-2 col-md-1">
                            ...
                            <div class="col-xs-4 col-sm-2 col-md-2 bakBtn">
                                <asp:Button ID="Button1" runat="server" CssClass="btn btn-success" Text="Back" CausesValidation="false"
                                    PostBackUrl="~/Pages/Setup/CadreList.aspx" />
                            </div>
                        </div>
                    </div>
                </asp:Panel>
